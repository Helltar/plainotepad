...
- [plainotepad-0.9.11.tar.gz](https://github.com/Helltar/plainotepad/releases/download/0.9.11/plainotepad-0.9.11.tar.gz) (2.53 MB)
...
```
```
tar -xvf plainotepad-0.9.11.tar.gz
```
```
./plainotepad
```
