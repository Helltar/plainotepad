...
- [plainotepad-0.9.12.tar.gz](https://github.com/Helltar/plainotepad/releases/download/0.9.12/plainotepad-0.9.12.tar.gz) (2.62 MB)
...
```
```
tar -xvf plainotepad-0.9.12.tar.gz
```
```
./plainotepad
```
