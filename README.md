...
- [plainotepad-0.9.13.tar.gz](https://github.com/Helltar/plainotepad/releases/download/0.9.13/plainotepad-0.9.13.tar.gz) (2.62 MB)
...
```
```
tar -xvf plainotepad-0.9.13.tar.gz
```
```
./plainotepad
```
